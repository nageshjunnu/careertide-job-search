...
export const setupApi = {
  ...
  createPaymentOrder: () => makeApiCall<{ subscriptionId: string; checkoutKey: 'subscription_id'; amount: number; currency: string; keyId: string; mode: string }>(`${API_URL}/api/payments/order`, { method: 'POST', timeoutMs: 30_000 }),
