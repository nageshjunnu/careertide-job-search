...
export type AdminUser = { id: string; full_name: string; email: string; phone: string | null; created_at: string; roles: string | null; experience: string | null; locations: string | null; workflow_status: string; schedule: string | null; timezone: string | null; matches: number }
